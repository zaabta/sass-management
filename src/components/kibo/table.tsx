/**
 * Kibo Table — ported from github.com/shadcnblocks/kibo (packages/table).
 * TanStack Table + jotai sorting + shadcn table primitives.
 */
...
import { Table as TableRaw, TableBody as TableBodyRaw, TableCell as TableCellRaw, TableHead as TableHeadRaw, TableHeader as TableHeaderRaw, TableRow as TableRowRaw } from '../ui/shadcn/table';
